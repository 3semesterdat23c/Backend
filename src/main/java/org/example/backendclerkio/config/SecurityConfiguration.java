...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/**")  // /** means match any string recursively
                .allowedOriginPatterns("http://localhost:*","https://3semesterdat23c.github.io/*", "https://randomshop-gddudvarb6gwb7ep.westeurope-01.azurewebsites.net/*") //Multiple strings allowed. Wildcard * matches all port numbers.
